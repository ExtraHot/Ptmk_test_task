...
Это консольное приложение для работы с базой данных PostgreSQL. Оно позволяет управлять справочником сотрудников: создавать таблицы, добавлять записи, выводить данные и выполнять другие операции.

Приложение сделано согласно следующему ТЗ
